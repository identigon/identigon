...
the single root [`PLAN.md`](PLAN.md) tracks the whole backlog (optionally tagged by subproject) -
see [`DOC-MAP.md`](DOC-MAP.md) for the full map, and the subproject's own README for what it does
and how to use it. Release history is split at the point the three merged: the root
[`CHANGELOG.md`](CHANGELOG.md) covers pre-1.0.0 history too (project-prefixed version tags), as
well as every shared release from 1.0.0 onward.
