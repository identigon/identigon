...
class GenericDialectHandlerTest {
    ...
    /**
     * {@code GenericDialectHandler} doesn't override {@code bindValue}, so it gets
     * {@code DialectHandler}'s plain-{@code setObject} default - unlike
     * {@code PostgresDialectHandler}, a {@code String} value gets no {@code Types.OTHER} coercion
     * here, proving that rule really is Postgres-specific and not baked into the shared default.
     */
    @Test
    ...
    private static PreparedStatement recordingPreparedStatement(List<String> calls) {
        ...
        return (PreparedStatement) Proxy.newProxyInstance(
            GenericDialectHandlerTest.class.getClassLoader(), new Class<?>[] {PreparedStatement.class}, h);
    }
}
