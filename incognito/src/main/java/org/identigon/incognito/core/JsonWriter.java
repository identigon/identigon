 ...
 * Produces compact single-line output with a readable {@code "key": value} / {@code , } token
 * style. Not a general-purpose library - it supports exactly the shapes {@link DpiaArtefactEmitter}
 * needs.
 */
final class JsonWriter {

  private final StringBuilder sb = new StringBuilder();
  // One frame per open object/array; frame[0] = "this container already has a child" (needs a
  // comma).
