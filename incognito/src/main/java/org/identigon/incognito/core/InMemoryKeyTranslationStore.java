...
public final class InMemoryKeyTranslationStore implements KeyTranslationStore {
  ...
  @Override
  public void put(String tableName, Object oldPk, Object newPk)
      throws IncognitoException.StoreException {
    store.computeIfAbsent(tableName, k -> new ConcurrentHashMap<>()).put(oldPk, newPk);
  }

  @Override
  public Optional<Object> get(String tableName, Object oldPk)
      throws IncognitoException.StoreException {
