...
public final class InMemoryAttributeCascadeStore implements AttributeCascadeStore {
  ...
  public Optional<Object> get(String parentTable, Object parentId, String attributeName) {
    return Optional.ofNullable(
        attributes.get(new AttributeKey(parentTable, parentId, attributeName)));
  }

  @Override
  public Optional<Object> resolveSharedAncestor(
      String tableA, Object idA, String tableB, Object idB, String attributeName) {
  ...
  @Override
  public void putJitterDelta(
      String coherenceGroup, String parentTable, Object parentId, long deltaDays) {
  ...
  public Optional<Long> getJitterDelta(String coherenceGroup, String parentTable, Object parentId) {
    return Optional.ofNullable(
        jitterDeltas.get(new JitterKey(coherenceGroup, parentTable, parentId)));
  }
