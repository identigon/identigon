...
verified source data. This is the repeatable, documented process required by
docs/spec/alterego.md section 9 and docs/research/0001-alterego-dictionaries.md's three-part
gate: every value below is cited to a specific source recorded in
docs/research/0001-alterego-dictionaries.md, not typed from memory. Re-running this script
...
repeated-key structure - see docs/research/0001-alterego-dictionaries.md for the full per-source
breakdown this summarises.
...
# --- Surnames --------------------------------------------------------------------------------
# Authored, not sourced (ADR 10, docs/research/0001-alterego-dictionaries.md "Surnames"):
...
# and is listed once per area (see ADR 25 and docs/research/0001-alterego-dictionaries.md's
# well-formedness exception for this).
...
TOWNS_SOURCE = (
    ...
    "Mail-derived reference sources. See docs/research/0001-alterego-dictionaries.md for the "
    "full per-nation source breakdown."
)
TOWNS_DATA_URL = (
    "https://en.wikipedia.org/wiki/List_of_ONS_built-up_areas_in_England_by_population "
    "(and equivalent per-nation sources cited in docs/research/0001-alterego-dictionaries.md)"
)

# --- Street themes -----------------------------------------------------------------------------
# Authored, not sourced (ADR 10, docs/research/0001-alterego-dictionaries.md "Street names"):
# deliberately obviously
...
#
# Tagged MODIFIER/NOUN (ADR 26 has the generation-algorithm reasoning;
# docs/research/0001-alterego-dictionaries.md has the mining/curation detail): a name composes as
# [MODIFIER-or-NOUN] + NOUN + NOUN, each word
...
def main() -> None:
    ...
    # "Surnames"/"Street themes" comments above and docs/research/0001-alterego-dictionaries.md.
