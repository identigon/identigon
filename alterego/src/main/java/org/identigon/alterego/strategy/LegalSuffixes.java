 ...
 * four forms are the exact abbreviations Companies Act 2006 ss.58(2) (public limited company) and
 * 59(2) (private limited company) permit, including the Welsh-language alternatives a Welsh company
 * may use in place of the English forms.
 */
final class LegalSuffixes {

  private static final Map<String, List<String>> BY_COUNTRY =
      Map.of("GB", List.of("Ltd", "plc", "Cyf.", "c.c.c."));
