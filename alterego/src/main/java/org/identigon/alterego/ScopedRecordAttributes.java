...
/**
 * The {@link RecordAttributes} seen inside an active {@link RecordScope} (section 6.2): reads and
 * writes go to the scope's shared map, so every context created while the scope is active -
