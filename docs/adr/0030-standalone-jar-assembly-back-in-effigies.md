...
product. That bundled two separable questions together: which Maven *coordinate* the fat jar
publishes under, and which Gradle project's build script owns the *task* that assembles it.
