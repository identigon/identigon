...
# 20. INHERITED_ATTRIBUTE resolved from the root ancestor, fail-closed
...
Chosen option: "fail-closed root-ancestor resolution", because the fail-open alternative silently
passes real data through exactly when resolution is hardest to verify.
