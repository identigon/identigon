...
/**
 * Formats a column's discovered metadata (type, PK, FK) as the short human-readable annotation
 * both {@code discover} and {@code scaffold} print alongside it -- shared so the two commands
 * can't drift into describing the same column differently.
 */
