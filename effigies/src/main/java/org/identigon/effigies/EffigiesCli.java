 ...
 * <a href="https://github.com/identigon/identigon/tree/main/incognito">incognito</a>. Effigies
 * discovers a source schema, helps author (and, later, infer) the declarative anonymisation policy,
 * and drives the engine to produce the anonymised clone. The engine stays deterministic and
 * judgment-free; all inference and scaffolding lives here (see {@code
 * docs/adr/0001-authoring-above-the-engine.md}).
 *
  ...
  private static void printUsage(PrintStream w) {
    w.println(
        """
            ...
            Commands:
              discover    Inspect a source database and describe its schema (metadata only,
                          no data).
              scaffold    Emit a starter policy.yaml (fail-closed: every column left to be
                          classified).
